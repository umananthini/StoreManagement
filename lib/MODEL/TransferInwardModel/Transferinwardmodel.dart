...
factory TransferInwardDataModelHeader.fromJson(Map<String,dynamic>jsons,int rescode){
if(jsons !=null){
  var Listt= json.decode(jsons['data'] ) as List;
    List<TransferInwardDataModel> finaldata= Listt.map((e)=>TransferInwardDataModel.fromJson(e)).toList();
...
factory TransferInwardDataModelHeader.execption(Map<String,dynamic>jsons,int rescode){
  return TransferInwardDataModelHeader(
    data: null,
     execption: "API Error",
      rescode: rescode);
