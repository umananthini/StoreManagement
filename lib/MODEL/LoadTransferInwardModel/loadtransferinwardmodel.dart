...
class LoadTransferHeader {
  ...
  factory LoadTransferHeader.fromJson(
    ...
    if (jsons != null) {
      ...
      return LoadTransferHeader(
          Dataa: data.fromJson(datalist), execption: null, statuscode: 200);
    } else {
      return LoadTransferHeader(
          Dataa: null, execption: "No Data", statuscode: statusCode);
    }
  }
  factory LoadTransferHeader.execption(
      Map<String, dynamic> jsons, int statusCode) {
    return LoadTransferHeader(
        Dataa: null, execption: jsons["respDesc"], statuscode: 400);
  }
  factory LoadTransferHeader.issues(String jsons, int statusCode) {
    return LoadTransferHeader(
        Dataa: null, execption: "Server not Connect", statuscode: 500);
  }
}
...
class data {
  ...
  factory data.fromJson(Map<String, dynamic> jsons) {
    if (jsons["Inward"] != null) {
      ...
      List<loadtransferinward1> finalInward1 =
          Inward1.map((e) => loadtransferinward1.fromJson(e)).toList();
      var InwardItems1 = (jsons["InwardItems"]) as List;
      List<loadtransferInwardItems1> finalInwardItems1 =
          InwardItems1.map((e) => loadtransferInwardItems1.fromJson(e))
              .toList();
      return data(
          LoadTransferInward1: finalInward1,
          LoadTransferInwardItems1: finalInwardItems1);
    } else {
      return data(LoadTransferInward1: null, LoadTransferInwardItems1: null);
    }
  }
}
