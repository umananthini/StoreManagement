...
class LoginDropDownHeader{
  ...
  factory LoginDropDownHeader.fromJson(Map<String,dynamic>jsons,int rescode ){
    if(jsons !=null){
      var Listts=   json.decode(jsons["data"]) as List;
      List<LoginDropDownModel> finalLists= Listts.map((e) =>LoginDropDownModel.fromJson(e)).toList();
  ...
  factory LoginDropDownHeader.execption(Map<String,dynamic>jsons,int rescode){
