...
class _PurchaseInwNewFirstState extends State<PurchaseInwNewFirst> {
  ...
  Future<bool> onbackpress() {
    ...
    if (currentBackPressTime == null ||
      ...
      context
                          .read<PurchaseInwardCtrl>().searchfilter1.clear();
      ...
      child: Scaffold(
                  ...
                  InkWell(
                    onTap: (){
                      setState(() {
                       ...
                       context
                          .read<PurchaseInwardCtrl>().issearchpressed1 = !  context
                          .read<PurchaseInwardCtrl>().issearchpressed1;
                      });
                    },
                    child: Container(
                      padding: EdgeInsets.symmetric(
          ...
          body: Container(
            ...
            child: Column(
              children: [
                  context
                          .watch<PurchaseInwardCtrl>().issearchpressed1==false?Container(): Container(
                  ...
                  child: TextFormField(
                    controller:  context
                          .read<PurchaseInwardCtrl>().searchfilter1,
                                    ...
                                    [BoxShadow(
                                      ...
                                      Container(
                                        ...
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                                Container(
                                                  padding: EdgeInsets.symmetric(horizontal: Screens.padingHeight(context)*0.008),
                                          ...
                                          SizedBox(height: Screens.padingHeight(context)*0.008,),
                                          Container(
                                                  padding: EdgeInsets.symmetric(horizontal: Screens.padingHeight(context)*0.008),
                                              ...
                                              children: [
                                                ...
                                                Screens.width(context) * 0.2,
                                                 ...
                                                 Container(
                                                  ...
                                                  // color: const Color.fromARGB(255, 231, 186, 182),
