            ...
            children: [
                    ...
                    Container(
                      child:context
                            ...
                            .isloading ==true? Container(
                              padding: EdgeInsets.only(top: Screens.padingHeight(context)*0.1),
                              child: Center(child: CircularProgressIndicator(color: secondary,),)): Column(
                        children: [
                             context
                            .watch<SellableoDispController>()
                            .isshowtextfield ==false?Container(): 
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(" ${context.read<SellableoDispController>().GetBoxSeriallist[0].ItemCode}",style: theme.textTheme.bodyMedium!.copyWith(
                                  ...
                                  SizedBox(
                                   ...
                                   Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                         width: Screens.width(context)*0.7,
                                        child: Text(" ${context.read<SellableoDispController>().GetBoxSeriallist[0].ItemName}",style: theme.textTheme.bodyMedium!.copyWith(
                                   ...
                                   Row(
                                    ...
                                    children: [
                                      Container(
                                         width: Screens.width(context)*0.2,
                                        child: Text("Division :",style: theme.textTheme.bodyMedium!.copyWith(
                                      ...
                                      Container(
                                         width: Screens.width(context)*0.7,
                                        child: Text(" ${context.read<SellableoDispController>().GetBoxSeriallist[0].Division}",style: theme.textTheme.bodyMedium!.copyWith(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: TextFormField(
                                    readOnly: context.watch<SellableoDispController>().checkFUR==true?true:false,
                                ...
                                onTap: () {
                                    setState(() {
                                      context
                                          .read<SellableoDispController>()
                                          .Scanvalue2 = null;
                                      QRscannerState.sellablerpoductdetailsscan =
                                          true;
                                    });
              ...
              Container(
                ...
                child: ElevatedButton(
                    ...
                    onPressed:context.watch<SellableoDispController>().finalloading ==true?(){}: () {
                      context.read<SellableoDispController>().finalvalidate(context);
                    },
                    child:context.watch<SellableoDispController>().finalloading ==true?Center(
