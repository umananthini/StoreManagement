                      ...
                      InkWell(
                        onTap: (){
                          setState(() {
                           onbackpress();
                             context
                          .read<TransferInwardctrl>().searchfilter2.clear();
                          });
                        },
                          ...
                          Container(
                            child: Row(
                              ...
                              context
                                          ...
                                          .TransferLoad1 !=
                                      null
                              ?   Text("${context.read<TransferInwardctrl>().ScannedQty()}/${context.read<TransferInwardctrl>().TransferLoad1!.Quantity.toString()}",
):Container(),
                              ],
                            ))
                        ],
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
           context
                          .read<TransferInwardctrl>().issearchpressed2==false? Container(): Container(
              // height: Screens.padingHeight(context) * 0.06,
              decoration: BoxDecoration(
                  color: Colors.grey[200], borderRadius: BorderRadius.circular(10)),
              child: TextFormField(
                controller:  context
                          .read<TransferInwardctrl>().searchfilter2,
                  onChanged: (v) { 
                      context
                          .read<TransferInwardctrl>()
                          .SearchFiltertrans(v);
