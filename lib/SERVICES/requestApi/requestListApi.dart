...
class RequestListApi {
  ...
  static Future<RequestModel> getData() async {
    try {
      ...
      return RequestModel.issues(e.toString(), 500);
    }
  }

  static Future<RequestApprovalModel> getApprovalData(
      String cardCode, String value, String id, String sp) async {
    try {
      log(jsonEncode({
        "CardCode": cardCode,
        "CreditVal": value,
      ...
      if (responce.statusCode == 200) {
        return RequestApprovalModel.fromJson(
            json.decode(responce.body), responce.statusCode);
      } else {
        return RequestApprovalModel.fromJson(
            json.decode(responce.body), responce.statusCode);
  ...
  static Future<RequestApprovalModel> getRejectData(
      String cardCode, String value, String id, String sp) async {
    try {
      final responce = await http.post(
          Uri.parse(
