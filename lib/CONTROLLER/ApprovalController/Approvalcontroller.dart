        ...
        content: Container(
          child: Column(
            ...
            children: [
             ...
             child: Text("Alert",style: theme.textTheme.bodyMedium!.copyWith(
              ...
              Container(
                child: Text("Do You want to accept the Approval ?",style: theme.textTheme.bodyMedium!.copyWith(
              fontWeight: FontWeight.bold,
             ),),
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child:finalloading ==true?SpinKitThreeBounce(
 ...
 postfinalApi(BuildContext context,Getapprovalchild data)async{
  ...
  await FinalApprovalApi.getData(data.ItemCode, data.SerialNo).then((value) {
    if(value.stcode! >=200 && value.stcode! <=200){
      finalloading = false;
        showdialogsave(
            context, "Assets/check.png", "Success","Approved successfully..!!");

    }else if(value.stcode! >=400 && value.stcode! <=400){
      finalloading = false;
        showdialogsave(
            context, "Assets/check.png", "Failed", value.exception.toString());
            notifyListeners();
 ...
 showdialogsave(
              ...
              content: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                     title.contains("Success")?Text("transwer outward added successfully"):   Text(
                          title,
  ...
  Approvalfilterdetails(String v) {
    ...
    if (v.isNotEmpty) {
      ...
      Searchfiltergetapproval = getapproval.where(
        (e) => (e).ItemCode!.toString().toLowerCase().contains(v.toLowerCase(),)||
        (e).ItemName.toString().toLowerCase().contains(v.toLowerCase(),) ||
        (e).SerialNo.toString().toLowerCase().contains(v.toLowerCase(),) ||
        (e).Category.toString().toLowerCase().contains(v.toLowerCase(),) 
